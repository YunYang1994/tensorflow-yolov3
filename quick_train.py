...
# for image_path in dataset.keys():
    # if image_path != "./data/train_data/images/quick_train_data/000000371648.jpg": continue
    ...
    # utils.draw_boxes(image, true_boxes, scores, true_labels, classes, image.size)
